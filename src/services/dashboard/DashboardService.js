  ...
  dashboardSpace() {
    ...
    const welkomstboodschap = computed(() => {
      ...
      const waarschuwing = heeftGeenContactgegevens
        ...
        : "";
      return (
        `<p>Jouw Scouts & gidsen Vlaanderen account is voltooid. Hiermee kan je op de Groepsadministratie jouw <span class="welkom-dialog-nowrap"><i class="far fa-user welkom-dialog-tekst-icoon"></i><span class="welkom-dialog-link">persoonlijke gegevens</span></span> en
        ...
        `</ul>` +
        waarschuwing +
        `<p>Controleer zeker jouw e-mail (en gsm-nummer) zodat je de toegang tot jouw account niet verliest.` +
