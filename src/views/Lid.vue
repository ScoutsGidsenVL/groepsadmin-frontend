<template>
  <div id="lid-content" class="content">
    <lid-boven-balk :lid="lid" :id="id"></lid-boven-balk>
    <form @submit.prevent="opslaan" autocomplete="off">
      <div class="row">
        ...
        <div class="col-12 col-lg-6 col-xl-4">
          ...
          <groepseigen-gegevens v-model="lid.groepseigenVelden" :title="'Groepseigen gegevens'"></groepseigen-gegevens>
        </div>
        <div class="col-12 col-lg-12 col-xl-4">
          <functies :title="'Functies'" v-model="gesorteerdeFuncties"></functies>
        </div>
      </div>
      <Button icon="pi pi-save" class="p-button-rounded add-adres-button" type="submit"/>
    </form>
  </div>
</template>
    ...
    sorteerFuncties() {
      ...
      this.lid.functies.forEach((functie) => {
        ...
        let functieObject = {
          ...
          begin: functie.begin,
          einde: functie.einde,
          specialeFunctie: functie.functie === specialeFuncties.FV || functie.functie === specialeFuncties.VGA,
