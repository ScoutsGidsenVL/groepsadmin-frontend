    ...
    <card>
      <template #title>
        <div class="d-flex col-12 justify-content-between">
          ...
          <Button
            ...
            class="stop-knop"
            title="Stop alle functies"
            label="Stop alle functies"
            @click="stopAlleFuncties"
          />
        </div>
      ...
      <template #content>
        <accordion :multiple="true" v-show="!laden">
          <accordionTab
            v-for="(functies, nummer) in actieveGroepen"
            :key="nummer"
              ...
              <div v-if="functie.actief" class="functie-wrapper">
                <div class="flex-row">
                  <div class="flex justify-content-between">
                    ...
                    <Button
                      v-if="
                        lidMagFunctieStoppen('functies.' + nummer) &&
                        !functie.specialeFunctie
                      "
                      icon="pi pi-trash"
              ...
              >
                <div class="flex-row">
                  <div class="justify-content-between">
                    <label
                      >van {{ formatteerDatum(functie.begin) }}&nbsp;</label
                    >
        ...
        <div v-if="historiek && !laden">
          <accordion :multiple="true">
            <accordionTab
              v-for="(functies, index) in nietActieveGroepen"
              :key="index"
              :header="inactieveGroepsNaam(index)"
            >
              <div
                v-for="(functie, index) in functies"
                :key="index"
                class="opacity-50"
              >
                <div class="flex-row">
