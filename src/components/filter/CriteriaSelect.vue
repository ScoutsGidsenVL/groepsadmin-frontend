<template>
  <div class="col-12 col-sm-6 col-lg-3 col-xl-2 pointer" v-click-outside="closeMenu">
    <div @click="toggleMenu = !toggleMenu"
      ...
      <i class="fa fa-plus"></i><label class="ml-2 pointer line-height-1">Nieuw Criterium</label>
    </div>
